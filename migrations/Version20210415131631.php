 ...
 */
final class Version20210415131631 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, resource_id INT NOT NULL, author_id INT NOT NULL, comment LONGTEXT NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_9474526C89329D25 (resource_id), INDEX IDX_9474526CF675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE patch_note (id INT AUTO_INCREMENT NOT NULL, resource_id INT NOT NULL, version VARCHAR(50) NOT NULL, description VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, link VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, publish_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, latest TINYINT(1) NOT NULL, INDEX IDX_7C82413E89329D25 (resource_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE resource (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, category_id INT NOT NULL, name VARCHAR(50) NOT NULL, description VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, slug VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, validation INT NOT NULL, INDEX IDX_BC91F416A76ED395 (user_id), INDEX IDX_BC91F41612469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
